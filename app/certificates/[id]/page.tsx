...
export default function PublicCertificatePage({ params }: PageProps) {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      alert('ডাউনলোড ত্রুটি: ' + (err?.message || 'Error generating image'));
    } finally {
    ...
    <section className="section" style={{ paddingTop: '40px', paddingBottom: '60px' }}>
      <div className="container">
        ...
        >
          ...
          >
            এই মর্মে পরম শ্রদ্ধার সাথে প্রত্যয়ন করা যাচ্ছে যে,{' '}
            <strong style={{ color: '#DC2626', fontSize: '1.35rem' }}>{certificate.donorName}</strong> চাঁভালি রক্ত
            ফাউন্ডেশনের মাধ্যমে মানবসেবায় স্বেচ্ছায় রক্তদান করে একটি অমূল্য প্রাণ রক্ষায় অনন্য ভূমিকা রেখেছেন।
          </p>
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: '1.15rem', fontWeight: 700, color: '#1f2937' }}>
                {certificate.donationNumber || `CBF-${certificate.id}`}
              </div>
            </div>
          </div>
