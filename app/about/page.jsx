    ...
    return (
        <section className="section" id="about" style={{ paddingTop: '40px' }}>
            <div className="container">
                ...
                <div style={{ marginTop: '60px', padding: '40px 30px', background: '#fff', borderRadius: '20px', boxShadow: 'var(--shadow)' }}>
                    <h3 style={{ fontSize: '1.4rem', color: 'var(--primary)', marginBottom: '16px', textAlign: 'center' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px', marginTop: '24px' }}>
                        <div style={{ padding: '20px', background: '#fef2f2', borderRadius: '12px', borderLeft: '4px solid #DC2626' }}>
                            <h4 style={{ color: '#991B1B', marginBottom: '8px' }}>জরুরি রক্ত ব্যবস্থাপনা</h4>
                            <p style={{ fontSize: '0.9rem', color: '#4b5563', margin: 0 }}>হাসপাতালে ভর্তি রোগীর জন্য অতি দ্রুত উপযুক্ত গ্রুপের রক্তদাতা খুঁজে দেওয়া।</p>
                        </div>
                        <div style={{ padding: '20px', background: '#fef2f2', borderRadius: '12px', borderLeft: '4px solid #DC2626' }}>
                            <h4 style={{ color: '#991B1B', marginBottom: '8px' }}>রক্তদান কর্মসূচি</h4>
                            <p style={{ fontSize: '0.9rem', color: '#4b5563', margin: 0 }}>বিভিন্ন সামাজিক অনুষ্ঠান ও শিক্ষাপ্রতিষ্ঠানে ফ্রি রক্তের গ্রুপ নির্ণয় ও রক্তদান ক্যাম্পেইন।</p>
                        </div>
                        <div style={{ padding: '20px', background: '#fef2f2', borderRadius: '12px', borderLeft: '4px solid #DC2626' }}>
                            <h4 style={{ color: '#991B1B', marginBottom: '8px' }}>সচেতনতা সৃষ্টি</h4>
                            <p style={{ fontSize: '0.9rem', color: '#4b5563', margin: 0 }}>তরুণ প্রজন্মকে রক্তদানে উদ্বুদ্ধ করতে লিফলেট বিতরণ ও মোটিভেশনাল সভা পরিচালনা।</p>
                        </div>
                    </div>
                </div>
            </div>
