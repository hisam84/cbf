...
export default function HomePage() {
    const [stats, setStats] = useState({ totalDonors: 0, totalDonations: 0 });
                ...
                <div className="hero-content">
                    ...
                    <div className="hero-stats">
                        ...
                        <div className="stat-item">
                            ...
                            <span className="stat-label">রক্তের গ্রুপ</span>
                        </div>
                        <div className="stat-item">
            ...
            <section style={{ padding: '30px 20px', background: '#DC2626', color: '#fff' }}>
                <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '20px' }}>
                    <div>
                        ...
                        <p style={{ margin: '4px 0 0 0', opacity: 0.9 }}>আমাদের ডেটাবেসে সকল রক্তের গ্রুপের নিবন্ধিত রক্তদাতা রয়েছে।</p>
                    </div>
                    <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                        <a 
                            href="tel:+8801757831838" 
                            style={{ background: '#fff', color: '#DC2626', padding: '10px 20px', borderRadius: '30px', fontWeight: 700, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '8px' }}
                        >
                            📞 ০১৭৫৭-৮৩১৮৩৮
                        </a>
                        <Link 
                            href="/donors" 
                            style={{ background: 'rgba(0,0,0,0.25)', color: '#fff', padding: '10px 20px', borderRadius: '30px', fontWeight: 600, textDecoration: 'none', border: '1px solid rgba(255,255,255,0.4)' }}
                        >
                            তালিকা দেখুন →
                        </Link>
                    </div>
                ...
                <div className="container">
                    ...
                    {donations.length > 0 ? (
                        <div className="donation-slider">
                            <div className="slider-container" style={{ position: 'relative', overflow: 'hidden', minHeight: '380px' }}>
                                    ...
                                    return (
                                        ...
                                        >
                                            {d.image ? (
                                                ...
                                                <div style={{ width: '100%', height: '240px', background: '#fee2e2', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '3rem' }}>
                                                    🩸
                                                </div>
                                            )}
                                            <div className="donation-slide-content">
                                                ...
                                                {d.notes && (
                                                    <p style={{ marginTop: '8px', fontSize: '0.9rem', color: '#4b5563', fontStyle: 'italic' }}>
                                                        "{d.notes}"
                                                    </p>
                                                )}
                                            </div>
                            ...
                            {donations.length > 1 && (
                                <>
                                    ...
                                    <button className="slider-btn prev-btn" onClick={prevSlide} aria-label="আগের স্লাইড">‹</button>
                                    <button className="slider-btn next-btn" onClick={nextSlide} aria-label="পরের স্লাইড">›</button>
                                </>
                            )}
                        </div>
                    ) : (
                        <div style={{ textAlign: 'center', padding: '50px 20px', background: '#fff', borderRadius: '16px', boxShadow: 'var(--shadow)' }}>
                            <p style={{ fontSize: '1.1rem', color: '#6b7280', margin: 0 }}>এখনও কোনো রক্তদান রেকর্ড যুক্ত করা হয়নি।</p>
                        </div>
                    )}
                </div>
            </section>
            ...
            <section className="section section-alt">
                <div className="container">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' }}>
                        <div style={{ background: '#fff', padding: '30px', borderRadius: '16px', boxShadow: 'var(--shadow)', textAlign: 'center' }}>
                            <div style={{ fontSize: '2.5rem', marginBottom: '16px' }}>❤️</div>
                            <h3 style={{ fontSize: '1.25rem', marginBottom: '10px', color: '#DC2626' }}>জীবন রক্ষা</h3>
                            <p style={{ color: '#4b5563', fontSize: '0.95rem' }}>দুর্ঘটনা, প্রসূতি মা ও থ্যালাসেমিয়া রোগীদের জন্য জরুরি রক্ত বেঁচে থাকার একমাত্র ভরসা।</p>
                        </div>

                        <div style={{ background: '#fff', padding: '30px', borderRadius: '16px', boxShadow: 'var(--shadow)', textAlign: 'center' }}>
                            <div style={{ fontSize: '2.5rem', marginBottom: '16px' }}>🩺</div>
                            <h3 style={{ fontSize: '1.25rem', marginBottom: '10px', color: '#DC2626' }}>স্বাস্থ্যের সুরক্ষা</h3>
                            <p style={{ color: '#4b5563', fontSize: '0.95rem' }}>নিয়মিত রক্তদানে হৃদরোগের ঝুঁকি কমে, রক্তচাপ নিয়ন্ত্রণে থাকে এবং শরীরে নতুন রক্তকণিকা তৈরি হয়।</p>
                        </div>

                        <div style={{ background: '#fff', padding: '30px', borderRadius: '16px', boxShadow: 'var(--shadow)', textAlign: 'center' }}>
                            <div style={{ fontSize: '2.5rem', marginBottom: '16px' }}>🤝</div>
                            <h3 style={{ fontSize: '1.25rem', marginBottom: '10px', color: '#DC2626' }}>মানবিক তৃপ্তি</h3>
                            <p style={{ color: '#4b5563', fontSize: '0.95rem' }}>একজন মুমূর্ষু রোগীকে রক্ত দিয়ে তার মুখে হাসি ফোটানোর আত্মিক আনন্দ আর কিছুতে নেই।</p>
                        </div>
                    </div>
                </div>
            </section>
